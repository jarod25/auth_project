<h1 align="center">Projet d'authentification en NodeJS avec JWT</h1>
...
1. Clonez le projet en utilisant la commande suivante : `git clone https://github.com/votre-nom/votre-projet.git`
